...
import com.example.demo.utils.transactionUtil.PgJDBCTransactionUtil;
...
@EnableAsync
@Slf4j
public class FlinkJDBCTransactionalTest {
...
//    @Scheduled(cron = "${env.dancing.cron:* 0/1 * * * ?}")
    public static void test(){
        ...
        DataStreamSink dataStreamSink = mapStream.addSink(new PgJDBCTransactionUtil("update user_info set age = ? where age = ?"));
